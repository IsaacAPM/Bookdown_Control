...
\hypersetup{
  pdftitle={Teoría de Control},
  pdfauthor={Isaac Alejandro Pimentel Morales},
  hidelinks,
...
Este mismo libro ha sido escrito en \href{http://rmarkdown.rstudio.com}{R-Markdown} empleando el paquete \href{https://bookdown.org/yihui/bookdown/}{\texttt{bookdown}} y está disponible en el repositorio Github: \href{https://github.com/IsaacAPM/Bookdown_Control}{IsaacAPM/Bookdown\_Control}.
...
{\centering \includegraphics[width=0.8\linewidth]{bookdown_control_files/figure-latex/nice-fig-1} 
